...
void registr()
{
    ...
    scanf("%[^\n]", p->name);
    scanf("%c",&temp1);
    gender: printf("Enter Gender[M/F/O]: ");
    scanf("%c",&p->sex);
    ...
    phone_num: printf("Enter Phone Number: ");
    scanf("%s",&p->phone_num);
    //printf(p->phone_num);
...
//    printf("				       (COMPOUNDED MONTHLY)\n\n");
    ...
    {
        printf("\n++++++++++++++++++++++++++++++++++++++++");
        printf("\nNet banking no: %d",p->nb);
        printf("\nAddress: %s",p->address);
        printf("\nName: %s",p->name);
        printf("\nPincode: %s",p->pincode);
        printf("\nSalary: %d",p->salary);
		printf("\nColateral value: %d",p->colateral);
        printf("\nPurpose of taking loan: %s",p->purpose);
        printf("\nEmployment type: %s",p->employement_type);
		printf("\nAmount: %d",p->amount);
        printf("\nEmail: %s",p->email);
        printf("\nLoan number: %d",p->loan_num);
        //printf("%s\n",p->loan_ap_name);
        //printf("%.2f\n",p->percent);
		printf("\n");
        p=p->next;
